...
<Command.Dialog bind:open>
	...
	<Command.List>
		...
		<Command.Group heading="Menu">
			...
			<Command.Item onclick={toggleMode}>
				<SunIcon
					class="mr-2 h-[1.2rem] w-[1.2rem] scale-100 rotate-0 !transition-all dark:scale-0 dark:-rotate-90"
				/>
				<MoonIcon
					class="mr-2 absolute h-[1.2rem] w-[1.2rem] scale-0 rotate-90 !transition-all dark:scale-100 dark:rotate-0"
				/>
				Theme - 
