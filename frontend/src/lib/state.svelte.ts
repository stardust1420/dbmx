...
export let tabsMap = $state<SvelteMap<number, model.Tab & { processedRows?: any[]; columnTypes?: string[] }>>(new SvelteMap<number, model.Tab & { processedRows?: any[]; columnTypes?: string[] }>());
